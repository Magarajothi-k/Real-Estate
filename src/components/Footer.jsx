        ...
        <div className='pt-10 px-4 md:px-20 lg:px-32 bg-gray-900 w-full overflow-hidden'
            ...
            items-start'>
                <div className='w-full md:w-1/3 mb-8 md:mb-0'>
                    ...
                    <p className='text-gray-400 mt-4'>Premium properties in prime locations — residential plots, luxury villas, and commercial spaces tailored to your dreams.
                        Trusted expertise, transparent deals, and seamless transactions to help you find the perfect place to call home. </p>
                </div>
                ...
                <div className='w-full md:w-1/3'>
                    ...
                    <p className='text-gray-400 mb-4 max-w-80'>The latest news, articles,
                        and resources, send to your inbox weekly</p>
