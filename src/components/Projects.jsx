...
const Projects = () => {
    ...
    return (
        ...
        lg:px-32 my-20 w-full overflow-hidden' id="Projects">
            ...
            <p className='text-center text-gray-500 mb-8 max-w-80 mx-auto'>Crafting
                Spaces, Building legacies-Explore Our Portfolio</p>
                ...
                ease-in-out' style={{
                    ...
                    {projectsData.map((project, index) => (
                        <div key={index} className='relative shrink-0 w-full sm:w-1/4'>
                            ...
                            flex justify-center'>
                                <div className=' inline-block bg-white w-full px-2 py-2 shawdow-md'>
