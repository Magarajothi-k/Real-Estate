...
const About = () => {
    ...
    md:px-20 lg:px-32 w-full overflow-hidden' id='About'>
            ...
            <p className='text-gray-500 max-w-80  text-center mb-8'>Passionate
                About Properties, Deticated to Your Vision</p>
             ...
             md:gap-20 '>
                ...
                <div className='flex flex-col items-center md:items-start mt-10
                 text-gray-600 ' >
                    ...
                    <div className='grid grid-cols-2  w-full gap-6 md:gap-10 2xl:pr-28'>
                        <div>
                    ...
                    <p className='my-5 max-w-lg'> We are a trusted real estate company delivering quality developments with a commitment to excellence, innovation, and customer satisfaction.
                    </p>
